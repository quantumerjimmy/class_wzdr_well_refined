"""
This file import k from the \Lambda-CDM model file, but remember to uncomment the corresponding line when doing so.
"""
import sys
...
#print(a_tau)
#a_tau = np.loadtxt('/home/quantumer/class_arb_fock_bandbox_jimmy_may/notebooks/a_tau.csv')
print(a_tau)
...
k = one_time['k (h/Mpc)']
k_num = len(k)
#k = np.loadtxt('/home/quantumer/class_arb_fock_bandbox_jimmy_may/notebooks/k_value.csv')      # Import csv from arb
#k = np.array(k)          # Replace the k from arb
#k_num = len(k)
